...
(N'Không kỳ hạn', 0.15, 15, 1, 100000, 100000),
...
EXEC GetSOTIETKIEMByMonthYearAndMaloaitietkiem
	@Month = 3,
    @Year = 2023,
    @Maloaitietkiem = 1;
GO
...
UPDATE SOTIETKIEM
SET Sodu = 10000000 
WHERE Masotietkiem = 1;
GO

UPDATE LOAITIETKIEM
SET Songayduocrut = 15
WHERE Maloaitietkiem = 1;
GO
...
TRUNCATE TABLE PHIEUGUITIEN
GO

TRUNCATE TABLE PHIEURUTTIEN
GO

TRUNCATE TABLE SOTIETKIEM
GO

DELETE LOAITIETKIEM WHERE Maloaitietkiem=7


UPDATE TAIKHOAN SET Matkhau = 51561651651 WHERE ID = 8
Select * from TAIKHOAN 

DELETE TAIKHOAN WHERE ID = 7
